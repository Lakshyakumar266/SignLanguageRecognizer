...
public class ConnectThread extends Thread {
    ...
    public ConnectThread(BluetoothDevice device, UUID MY_UUID, Handler handler) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
